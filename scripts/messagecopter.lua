...
if (sim_call_type==sim_childscriptcall_initialization) then 
    ...
    if rosInterfacePresent then
        publisher=simExtRosInterface_advertise('/pidrequest','PID_control/quadstate')
        subscriber=simExtRosInterface_subscribe('/pidreply','PID_control/motoroutputs','callback')
    end
...
if (sim_call_type==sim_childscriptcall_actuation) then 
    ...
    if rosInterfacePresent then
        simExtRosInterface_publish(publisher,request)
    end
